package com.zensorium.android.demo1.model;
...
public class MonitorDataModel {
    ...
    public  MonitorDataModel (int id, String sensorId, String userId, String sensorVal, String sensorUpdateTime, String accuracy) {
        this.id = id;
    ...
    public String toString() {
        return "MonitorData [id=" + id + ", userId=" + userId + ", sensorId=" + sensorId+ ", sensorVal=" + sensorVal + ", sensorUpdateTime=" + getDate(Long.getLong(sensorUpdateTime, 1)/1000000L)+ ", accuracy=" + accuracy
                + "]";
    }
